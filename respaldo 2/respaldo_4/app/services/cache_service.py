...
class SemanticCacheService:
        ...
        try:
            ...
            if similarity > self.threshold:
                ...
                if cached_item:
                    ...
                    # If the cache is global for general questions, we might ignore this.
                    # But for specific professional info, we MUST check.
                    # Current implementation: Simple check. 
                    # If professional_id doesn't match, it's a "Soft Miss" 
                    # (maybe same question but different professional answer).
    ...
    def add_to_cache(self, query, response, professional_id):
        ...
        try:
            ...
            self.id_map[current_idx] = new_cache
