...
from app import db
from app.models import Professional, User, Service, Experience, Certification, Comment, ProfessionalURL, Specialty
...
@profesionales_bp.route('/especialidades', methods=['GET'])
def get_specialties():
